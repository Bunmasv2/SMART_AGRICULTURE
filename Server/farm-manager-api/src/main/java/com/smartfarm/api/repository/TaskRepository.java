...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    List<Task> findTasksWithStageByBatchId(@Param("batchId") Long batchId);

    @Query("SELECT t FROM Task t WHERE t.plantingBatch.pBatchId = :batchId")
    List<Task> findByBatchId(@Param("batchId") Long batchId);
    ...
    List<Task> findTasksByBatchIdOrderByPlannedDateAsc(@Param("batchId") Long batchId);
}