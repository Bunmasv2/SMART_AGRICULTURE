                ...
                <div className="max-w-md w-full mx-auto space-y-8">
                    <div className="space-y-2">
                        ...
                        <p className="text-[#a8c69f] text-sm">
                            Đăng ký tài khoản để trải nghiệm các tính năng quản lý hiện đại.
                        </p>
                    </div>

                    <div className="flex gap-8 border-b border-[#2c5d3d] pb-2 text-sm font-medium">
                        <Link to="/login" className="text-[#a8c69f] hover:text-white pb-2">Đăng nhập</Link>
                        <Link to="/register" className="text-white border-b-2 border-white pb-2">Đăng ký</Link>
                    </div>
